...
const BookSuggestions = lazy(() => import('@/app/borrowbooks/book-suggestions-page'))
...
const BorrowBooks = lazy(() => import('@/app/borrowbooks/borrowed-books-page'))
...
const VerifyEmail = lazy(() => import('@/app/auth/verify'))
